...
int village_test(int currentPlayer, struct gameState *state, int handPos) {             //refactored already
   drawCard(currentPlayer, state);
...
int mineCard(struct gameState * state, int drawntreasure, int currentPlayer){
   int choice1, choice2, i, handPos;     
...
int adventurerCard(struct gameState * state, int drawntreasure, int currentPlayer){
   int cardDrawn;
...
int feastCard(struct gameState * state, int drawntreasure, int currentPlayer){
...
int great_hall_test(int currentPlayer, struct gameState *state, int handPos) {
   drawCard(currentPlayer, state);
   state->numActions++;
   discardCard(handPos, currentPlayer, state, 0);
...
int baronCard(struct gameState * state, int choice1, int currentPlayer){
